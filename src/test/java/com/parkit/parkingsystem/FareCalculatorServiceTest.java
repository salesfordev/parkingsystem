...
public class FareCalculatorServiceTest {
    ...
    // Price test for one hour of parking
    @Test
    ...
    //An exception is raised when parkingType is null(neither bike nor car).
    @Test
    ...
    // When the date of entry is later than the date of exit, an IllegalArgumentException is raised.
    @Test
    ...
    //29 minutes parking time should give 0 parking fare
    @Test
